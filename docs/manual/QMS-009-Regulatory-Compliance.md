...
```mermaid
graph TD
    A[Regulatory<br/>Requirements] --> B[HUD Code<br/>24 CFR 3280/3282]
    A --> C[CCR 8 CCR<br/>1302-14]
    A --> D[NEC 2023<br/>Article 550]
    A --> E[NTA TPIA<br/>Requirements]
    
    B --> F[Manufacturing<br/>Standards]
    C --> F
    D --> F
    E --> F
    
    F --> G[Fort Homes<br/>QMS Procedures]
    
    G --> H[Compliant<br/>Products]
    
    style A fill:#8B1414,stroke:#333,color:#fff,stroke-width:2px
    style B fill:#FFE5B4,stroke:#8B6914,stroke-width:2px
    style C fill:#FFE5B4,stroke:#8B6914,stroke-width:2px
    style D fill:#FFE5B4,stroke:#8B6914,stroke-width:2px
    style E fill:#FFE5B4,stroke:#8B6914,stroke-width:2px
    style G fill:#D4EDDA,stroke:#2D5016,stroke-width:2px
