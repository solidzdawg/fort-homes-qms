...
```mermaid
graph TD
    A[PLAN<br/>Identify Improvement] --> B[DO<br/>Implement Solution]
    B --> C[CHECK<br/>Measure Results]
    C --> D[ACT<br/>Standardize or Adjust]
    D --> A
    
    style A fill:#FFE5B4,stroke:#8B6914,stroke-width:2px
    style B fill:#D4EDDA,stroke:#2D5016,stroke-width:2px
    style C fill:#E7F3FF,stroke:#145B8B,stroke-width:2px
    style D fill:#F8F8F8,stroke:#333,stroke-width:2px
```
