...
5. **Leave expansion gap** of ⅛" at all perimeter edges (walls, rim boards) to allow for seasonal movement
...
| **Subfloor Flatness** | No humps >⅛" over 10' | Straightedge test |
...
| Subfloor edge gap >⅛" | Sheathing misalignment or swelling | Assess structural impact | Cut gap to spec or replace panel if compromised | Framing Crew + QA |
